...
The self-improving AI agent built by [Josh Research](https://nousresearch.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
- **Built by model trainers** — Created by [Josh Research](https://nousresearch.com), the lab behind Synapse, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Josh Research](https://nousresearch.com) — the lab behind Synapse, Nomos, and Psyche models
