...
- User-facing setup + troubleshooting: [Egress proxy](https://synapse-agent.nousresearch.com/docs/user-guide/egress/iron-proxy)
- Docker backend internals: [Docker](https://synapse-agent.nousresearch.com/docs/user-guide/docker)
- Bitwarden Secrets Manager integration: [`synapse secrets bitwarden`](https://synapse-agent.nousresearch.com/docs/user-guide/secrets/bitwarden)
- CLI command reference: [`synapse egress`](https://synapse-agent.nousresearch.com/docs/reference/cli-commands#synapse-egress)
- Sandbox-injected environment variables: [Egress proxy (sandbox-injected)](https://synapse-agent.nousresearch.com/docs/reference/environment-variables#egress-proxy-sandbox-injected)
