...
- **Profile-safe paths**: Never hardcode `~/.synapse` — use `get_synapse_home()` from `synapse_constants` for code paths and `display_synapse_home()` for user-facing messages. See [AGENTS.md](https://github.com/NousResearch/synapse-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/NousResearch/synapse-agent/blob/main/LICENSE).
