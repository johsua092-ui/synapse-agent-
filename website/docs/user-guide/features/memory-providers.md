...
See the [config reference](https://github.com/NousResearch/synapse-agent/blob/main/plugins/memory/honcho/README.md) and [Honcho integration guide](https://docs.honcho.dev/v3/guides/integrations/synapse).
...
See [plugin README](https://github.com/NousResearch/synapse-agent/blob/main/plugins/memory/hindsight/README.md) for the full configuration reference.
