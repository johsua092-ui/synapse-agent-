...
(`https://raw.githubusercontent.com/NousResearch/synapse-plugin-index/main/index.json`,
...
```json
{
  ...
  "subdir": null,
  "homepage": "https://github.com/NousResearch/synapse-media-studio",
...
[synapse-plugin-index](https://github.com/NousResearch/synapse-plugin-index)
