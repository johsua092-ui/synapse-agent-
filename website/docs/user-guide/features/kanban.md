...
[`merge-reconciler` skill](https://github.com/NousResearch/synapse-agent/blob/main/skills/autonomous-ai-agents/merge-reconciler/SKILL.md)
...
guide](https://github.com/NousResearch/synapse-agent/blob/main/docs/kanban/multi-gateway.md)),
