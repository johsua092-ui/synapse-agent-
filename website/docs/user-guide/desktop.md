...
The [manual update process](https://synapse-agent.nousresearch.com/docs/getting-started/updating) also works with the GUI.
...
`tccutil reset All com.nousresearch.synapse` and re-grant.
