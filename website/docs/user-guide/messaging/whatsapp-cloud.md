...
Message-template support (the workaround for outside-window sends) is not yet implemented in Synapse. If you need it, please [open an issue](https://github.com/NousResearch/synapse-agent/issues) — it's planned but waiting on a clear demand signal.
