...
The Portal's own [info page](https://portal.nousresearch.com/info) carries this warning too — it's the official Nous guidance, not just a Synapse-side opinion.
...
If a model is genuinely unavailable, [open an issue](https://github.com/NousResearch/synapse-agent/issues) — most gaps are routing config we can update.
