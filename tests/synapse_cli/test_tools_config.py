...
def test_save_platform_tools_preserves_mcp_server_names():
    ...
    Regression test for https://github.com/NousResearch/synapse-agent/issues/1247
    """
    config = {
        "platform_toolsets": {
...
def test_numeric_mcp_server_name_does_not_crash_sorted():
    ...
    Regression test for https://github.com/NousResearch/synapse-agent/issues/6901
    """
    config = {
