...
class TestWebServerEndpoints:
    ...
    def test_update_synapse_returns_docker_guidance_without_spawning(self, monkeypatch):
        ...
        assert "docker pull nousresearch/synapse-agent:latest" in data["message"]
        ...
        assert any("docker pull nousresearch/synapse-agent:latest" in line for line in status_data["lines"])
