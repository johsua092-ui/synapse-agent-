    ...
    [
        {
            ...
            "repo": "NousResearch/synapse-media-studio",
            "ref": "e" * 40,
        },
        {
            ...
            "repo": "NousResearch/synapse-telegram-business",
            "ref": "f" * 40,
        ...
        },
        {
            ...
            "author": "NousResearch",
            "tags": ["example", "llm"],
            "repo": "NousResearch/synapse-example-plugins",
...
class TestParsing:
    def test_parses_object_form(self):
        ...
        assert entries[2].install_identifier == (
            "NousResearch/synapse-example-plugins/plugin-llm-example"
        )
        assert entries[0].install_identifier == "NousResearch/synapse-media-studio"
...
class TestResolveName:
    ...
    def test_exact_unique(self):
        ...
        assert entry is not None and entry.repo == "NousResearch/synapse-media-studio"
...
class TestInstallResolution:
    ...
    def test_install_resolves_name_and_pins_ref(self, synapse_home, monkeypatch):
        ...
        assert captured["identifier"] == "NousResearch/synapse-media-studio"
...
class TestCmdSearch:
    def test_json_output(self, synapse_home, monkeypatch, capsys):
        ...
        assert payload["results"][0]["repo"] == "NousResearch/synapse-telegram-business"
