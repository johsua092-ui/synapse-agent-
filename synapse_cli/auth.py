...
SPOTIFY_DOCS_URL = "https://synapse-agent.nousresearch.com/docs/user-guide/features/spotify"
SPOTIFY_DASHBOARD_URL = "https://developer.spotify.com/dashboard"
SPOTIFY_ACCESS_TOKEN_REFRESH_SKEW_SECONDS = 120

OAUTH_OVER_SSH_DOCS_URL = "https://synapse-agent.nousresearch.com/docs/guides/oauth-over-ssh"
...
def _nous_portal_env_override() -> Optional[str]:
    ...
    ``SYNAPSE_PORTAL_BASE_URL=https://portal.staging-nousresearch.com`` into
