...
def _print_curator_first_run_notice() -> None:
    ...
    print(
        "  Docs:         https://synapse-agent.nousresearch.com/docs/user-guide/features/curator"
    )
...
def _update_via_zip(args, *, had_desktop_app_before_update: bool = False) -> bool:
    ...
    zip_url = (
        f"https://github.com/NousResearch/synapse-agent/archive/refs/heads/{branch}.zip"
    )
    ...
    try:
        ...
        print(
            ...
            "reinstall from https://synapse-agent.nousresearch.com"
        )
        _m().sys.exit(1)
    finally:
...
OFFICIAL_REPO_URLS = {
    "https://github.com/NousResearch/synapse-agent.git",
    "git@github.com:NousResearch/synapse-agent.git",
    "https://github.com/NousResearch/synapse-agent",
    "git@github.com:NousResearch/synapse-agent",
}

OFFICIAL_REPO_URL = "https://github.com/NousResearch/synapse-agent.git"
...
def _sync_with_upstream_if_needed(git_cmd: list[str], cwd: Path) -> None:
    ...
    if not has_upstream:
        ...
        print("  This means you may miss updates from NousResearch/synapse-agent.")
        print()
        try:
            response = (
        ...
        if response in {"", "y", "yes"}:
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print(
                    "  ✓ Added upstream: https://github.com/NousResearch/synapse-agent.git"
                )
                has_upstream = True
            else:
            ...
            print(
                "  Skipped. Run 'git remote add upstream https://github.com/NousResearch/synapse-agent.git' to add later."
            )
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        ...
        if not import_ok:
            ...
            print("    https://synapse-agent.nousresearch.com")
