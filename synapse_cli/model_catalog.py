...
DEFAULT_CATALOG_URL = (
    "https://synapse-agent.nousresearch.com/docs/api/model-catalog.json"
)
...
DEFAULT_CATALOG_FALLBACK_URLS: tuple[str, ...] = (
    "https://raw.githubusercontent.com/NousResearch/synapse-agent/main/website/static/api/model-catalog.json",
)
DEFAULT_TTL_HOURS = 1
