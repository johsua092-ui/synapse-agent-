...
_UPSTREAM_REPO_URL = "https://github.com/NousResearch/synapse-agent.git"
_OFFICIAL_REPO_CANONICAL = "github.com/nousresearch/synapse-agent"
...
def _github_compare_behind(current_rev: str, target_rev: str) -> Optional[int]:
    ...
    if not (_is_full_sha(current_rev) and _is_full_sha(target_rev)):
        return None
    url = (
        "https://api.github.com/repos/nousresearch/synapse-agent/"
...
_RELEASE_URL_BASE = "https://github.com/NousResearch/synapse-agent/releases/tag"
...
def get_latest_release_tag(repo_dir: Optional[Path] = None) -> Optional[tuple]:
    ...
    canonical NousResearch/synapse-agent repo (forks don't get a link).
    """
