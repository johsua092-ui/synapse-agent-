...
_DOCS_BASE = "https://synapse-agent.nousresearch.com/docs"
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://synapse-agent.nousresearch.com/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://synapse-agent.nousresearch.com/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
