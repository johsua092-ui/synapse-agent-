...
ULTRAPLINIAN_MODELS = [
    ...
    'nousresearch/synapse-3-llama-3.1-70b',
    'openai/gpt-4o',
    ...
    'nousresearch/synapse-4-405b',
    # POWER TIER (39-49)
    'nousresearch/synapse-3-llama-3.1-405b',
    'x-ai/grok-4',
    'z-ai/glm-4.7',
...
def race_godmode_classic(query, api_key=None, timeout=60):
    ...
    HALL_OF_FAME = [
        ...
        {
            'id': 'synapse-fast',
            'model': 'nousresearch/synapse-4-405b',
