...
Si tu habilidad es especializada, contribuida por la comunidad o de nicho, es mejor para un **Skills Hub** — súbela a un registro de habilidades y compártela en el [Discord de Josh Research](https://discord.gg/NousResearch). Los usuarios pueden instalarla con `synapse skills install`.
...
├── website/                  # Sitio de documentación (synapse-agent.nousresearch.com)
│
...
- Usa [GitHub Issues](https://github.com/NousResearch/synapse-agent/issues)
