...
describe('resolvePluginSourceLinks', () => {
  it('maps owner/repo to github browse and clone urls', () => {
    expect(resolvePluginSourceLinks('NousResearch/synapse-example-plugins')).toEqual({
      gitUrl: 'https://github.com/NousResearch/synapse-example-plugins.git',
      browseUrl: 'https://github.com/NousResearch/synapse-example-plugins',
      subdir: null
    })
  })
