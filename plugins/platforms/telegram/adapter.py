...
# trigger its own recovery path. Refs: NousResearch/synapse-agent#59614
...
# _UPDATER_STOP_TIMEOUT. Refs: NousResearch/synapse-agent#66377
_DRAIN_TIMEOUT = 15.0
        ...
        try:
            if app and app.updater and app.updater.running:
                try:
                    ...
                    # Refs: NousResearch/synapse-agent#58270
                    await _await_with_thread_deadline(
