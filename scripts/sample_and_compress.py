...
DEFAULT_DATASETS = [
    ...
    "NousResearch/synapse-agent-megascience-sft1",
    "NousResearch/Synapse-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Synapse-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-synapse-agent"
]
