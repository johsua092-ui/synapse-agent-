...
def get_synapse_home() -> Path:
    ...
    ``synapse_cli/kanban_db.py``).  See https://github.com/NousResearch/synapse-agent/issues/18594.
    """
...
def secure_parent_dir(path: Path) -> None:
    ...
    See https://github.com/NousResearch/synapse-agent/issues/25821.
    """
...
def is_container() -> bool:
    ...
    See: NousResearch/synapse-agent#47111
    """
...
def partial_update_hint(exc: BaseException) -> list[str]:
    ...
    return [
        ...
        "    synapse update",
        "If that also fails, reinstall: https://synapse-agent.nousresearch.com",
    ]
