...
Built for [Synapse Agent](https://github.com/NousResearch/synapse-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/synapse-agent/skills/creative/ascii-video`](https://github.com/NousResearch/synapse-agent/tree/main/skills/creative/ascii-video) via PR.
