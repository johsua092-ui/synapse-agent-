...
https://synapse-agent.nousresearch.com/docs/reference/cli-commands
...
Docs: https://synapse-agent.nousresearch.com/docs/user-guide/messaging/
...
|---|---|
| Config options | `synapse config edit` · [Configuration docs](https://synapse-agent.nousresearch.com/docs/user-guide/configuration) |
| Tools / toolsets | `synapse tools list` · [Tools reference](https://synapse-agent.nousresearch.com/docs/reference/tools-reference) |
| Skills catalog | `synapse skills browse` · [Skills catalog](https://synapse-agent.nousresearch.com/docs/reference/skills-catalog) |
| Provider setup | `synapse model` · [Providers guide](https://synapse-agent.nousresearch.com/docs/integrations/providers) |
| Env variables | `synapse config env-path` · [Env vars reference](https://synapse-agent.nousresearch.com/docs/reference/environment-variables) |
